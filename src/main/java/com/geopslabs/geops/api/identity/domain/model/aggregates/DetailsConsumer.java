 ...
 * It manages consumer preferences such as favorite categories, location permissions,
 * and saved addresses (home, work, university).
 *
...
public class DetailsConsumer extends AuditableAbstractAggregateRoot<DetailsConsumer> {
     ...
     */
    public DetailsConsumer(User user, String categoriasFavoritas,
     ...
     */
    public void updateConsumerDetails(String categoriasFavoritas,
